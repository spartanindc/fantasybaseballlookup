...
const MLB_STATS_URL =
  "https://api.mysportsfeeds.com/v1.2/pull/mlb/2018-regular/cumulative_player_stats.json?";

const statTrans = new Map([
  ["R", "Runs"],
  ["RBI", "RunsBattedIn"],
  ["HR", "Homeruns"],
  ["SB", "StolenBases"],
...
function getMLBData() {
  ...
  let sortDecider = "";
  if (
    ($("#pos").val() == "P" && $("#pit").val() == "ERA") ||
    ($("#pos").val() == "P" && $("#pit").val() == "WHIP")
  ) {
    sortDecider = ".A";
  } else {
    sortDecider = ".D";
